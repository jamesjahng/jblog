<template>
  <div id="app">
    <div id="site-title">
      <router-link to="/" class="mat-button no-shadow">James Jahng</router-link>
    </div>
    <nav>
      <router-link to="/"
...
export default {
  ...
  metaInfo: {
    title: 'About',
    titleTemplate: '%s :: James Jahng',
    meta: [
      { charset: 'utf-8' },
      {
        'property': 'og:title',
        'content': 'About',
        'template': chunk => `${chunk} :: James Jahng`,
        'vmid': 'og:title'
      },
      {
        'property': 'og:description',
        'content': 'Information of James Jahng',
        'template': chunk => `${chunk}`,
        'vmid': 'og:description'
      },
      {
        'property': 'og:image',
        'content': 'https://avatars2.githubusercontent.com/u/19753959?s=400&v=4',
        'template': chunk => `${chunk}`,
        'vmid': 'og:image'
      }
    ]
